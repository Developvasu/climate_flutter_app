...
class _LoadingPageState extends State<LoadingPage> {
  ...
  Future<http.Response> getWeatherData(Position position) async{
    final   http.Response response =  await http.get('https://api.openweathermap.org/data/2.5/weather?lat=${position.latitude}&lon=${position.longitude}&appid=e8fd4c337dfd075df2d16135a7d43661');
  ...
  void fetchWeatherData(Position position) async{
    FetchWeatherData fetchWeatherData = new FetchWeatherData(position);
